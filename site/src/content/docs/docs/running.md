---
title: "Running Andon: start, check, stop"
description: "Start, check, and stop each piece of Agent Andon — the board server, Tailscale Serve for phone access, and the optional content-blind relay."
---
...
| **`andon relay`** | 8788 | the content-blind hosted relay | only if you run your **own** relay — see [deploy-relay.md](/docs/deploy-relay/) |
