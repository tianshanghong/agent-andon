...
description: "콘텐츠를 읽지 못하는 Agent Andon 릴레이를 직접 호스팅하세요 — 봉인된 암호문만 전달하는 공유 진입점이라, 팀원들이 어디서나 자신의 보드에 접속할 수 있습니다."
---
...
콘텐츠를 읽지 못하는 자신만의 보드를 갖게 됩니다. (사용자 관점: [hosted.md](/ko/docs/hosted/).)
...
이 중 어느 것도 콘텐츠를 읽지 못한다는 보장에는 영향을 주지 않습니다(릴레이는 키나 평문을 절대 보유하지
