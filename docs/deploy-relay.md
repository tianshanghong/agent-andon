...
| `ANDON_IDLE_TTL_SEC` | `900` (15 min) | finished/idle sessions are dropped this long after their last event, so a torn-down team doesn't leave a wall of "ready" tiles; the 6h hard TTL still applies to active tiles |
